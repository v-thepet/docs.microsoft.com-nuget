...
## [Including content files](create-packages/content-files.md)
## [Guidance for .NET assemblies](create-packages/guidance-for-net-assemblies.md)
...
## [MSBuild props and targets](create-packages/msbuild-props-and-targets.md)
## [dotnet CLI tool package type](create-packages/dotnet-cli-tool-package-type.md)
