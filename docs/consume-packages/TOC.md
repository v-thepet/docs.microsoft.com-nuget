...
## [Install packages](consume-packages/ways-to-install-a-package.md)
...
## [Manage the global packages and cache folders](consume-packages/managing-the-global-packages-and-cache-folders.md)
